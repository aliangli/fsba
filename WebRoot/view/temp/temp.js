...
$(function(){
			...
			success : function(data) {
				if(data.codeType == 200){
					...
					if(user.userPhotoPath != null){
						$("#userPhoto").attr("src", "../../"+ data.userLoginPhotoPath +"/"+ user.userPhotoPath);
					}
					
					$("#userPhotoPath").val(user.userPhotoPath);
					$("#userPhoneNumber").val(user.userPhoneNumber);
					$("#aliasName").val(user.aliasName);
	...
	$("#btn_focus").click(function(){
		var param = {
				actionType:"nowUserFocus" ,
				pageNumber: 0  
			};
		
		$.ajax( {
			url : '../../userFocusController/getNowUserFocus',
			data : param,
			method: "POST",
			dataType : 'json', 
			success : function(data) {
	...
	$("#btn_focus_me").click(function(){
		var param = {
				actionType:"nowUserFocusPassive",
				pageNumber: 0 
			};
		
		$.ajax( {
			url : '../../userFocusController/getNowUserFocusPassive',
			data : param,
			method: "POST",
			dataType : 'json', 
			success : function(data) {
	...
	$("#btn_focus_xx").click(function(){
		...
		var param = {
				actionType:"userFocus", 
				userId: $("#focus_user_id").val(),
				pageNumber: 0
				
		};
		
		$.ajax( {
			url : '../../userFocusController/getFocusByUser',
			data : param,
			method: "POST",
			dataType : 'json', 
			success : function(data) {
	...
	$("#btn_focus_xx_p").click(function(){
		...
		$.ajax( {
			url : '../../userFocusController/getFocusByPassive',
			data : param,
			method: "POST",
			dataType : 'json', 
			success : function(data) {
	...
	$("#btn_is_focus_user").click(function(){
    	...
    	$.ajax( {
    		url : '../../userFocusController/isFocusPlayer',
    		data : param,
    		method: "POST",
    		dataType : 'json', 
    		success : function(data) {
	...
	function cancelFocus(userFocusId){
    	...
    	$.ajax( {
    		url : '../../userFocusController/cancelFocus',
    		data : param,
    		method: "POST",
    		dataType : 'json', 
    		success : function(data) {
